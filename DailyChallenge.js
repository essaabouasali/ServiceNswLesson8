// Go through the work for the Array Extension questions from Week 1 Day 4 and
...
const getOwner = pet =>{ return pet.ownerName };
...
const filterCallback = pet => pet.age < 5 && (pet.name[0]=="S" || pet.ownerName[0] == "S") ;
